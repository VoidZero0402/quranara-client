...
const OptionsSchema = z
    .array(
        z.object({
            text: z.string({ required_error: "وارد کردن متن گزینه الزامی است." }).min(1, { message: "متن گزینه نمی‌تواند خالی باشد." }).max(255, { message: "متن گزینه باید کمتر از ۲۵۵ کاراکتر باشد." }),
        }),
...
export const CreatePollSchema = z.object({
    ...
    identifier: z.string({ required_error: "وارد کردن شناسه الزامی است." }).min(1, { message: "شناسه نمی‌تواند خالی باشد." }).max(255, { message: "شناسه باید کمتر از ۲۵۵ کاراکتر باشد." }),
    description: z.string({ required_error: "وارد کردن توضیحات الزامی است." }).min(1, { message: "توضیحات نمی‌تواند خالی باشد." }).max(1024, { message: "توضیحات باید کمتر از ۱۰۲۴ کاراکتر باشد." }).optional(),
...
export const VoutePollSchema = z.object({
    option: z.string({ required_error: "وارد کردن گزینه الزامی است." }).min(1, { message: "گزینه نمی‌تواند خالی باشد." }).max(255, { message: "گزینه باید کمتر از ۲۵۵ کاراکتر باشد." }),
});
