...
export const CreateQuestionSchema = z.object({
    ...
    content: z.string({ required_error: "وارد کردن متن سوال الزامی است." }).min(1, { message: "متن سوال نمی‌تواند خالی باشد." }).max(2048, { message: "متن سوال باید کمتر از ۲۰۴۸ کاراکتر باشد." }).trim(),
    attached: z
        .object({
