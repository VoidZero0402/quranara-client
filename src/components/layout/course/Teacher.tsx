...
function Teacher({ teacher }: TeacherProps) {
    return (
        <div className="space-y-4 p-4 sm:p-6 bg-white dark:bg-gray-850 rounded-2xl w-full md:w-1/2 xl:w-full">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 leading-7"> من آموزش قرآن رو به صورت حرفه‌ای از 8 سالگی آغاز کردم و به مدت 3 سال مشغول یادگیری روخوانی و روانخوانی قرآن کریم و تجوید و ترتیل بودم</p>
        </div>
    );
}
