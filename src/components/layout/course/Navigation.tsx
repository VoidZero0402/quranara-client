...
function Navigation() {
    return (
        <div className="sticky top-4 flex justify-between p-6 bg-white dark:bg-gray-850 font-pelak-medium rounded-2xl shadow-2xl shadow-gray-100 dark:shadow-gray-900/50 z-20">
