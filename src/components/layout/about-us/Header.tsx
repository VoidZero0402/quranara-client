        ...
        <header>
            <div className="container">
                <section className="flex flex-col gap-y-2">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 leading-8">چی شد که قرآن‌آرا ساخته شد؟ رسالت قرآن‌آرا چیه؟ مؤسس قرآن‌آرا کیه؟ در این صفحه داستان شکل‌گیری قرآن‌آرا رو می‌خونیم، هدف اصلی و رسالت آکادمی قرآن‌آرا و خدماتش رو مرور می‌کنیم و با مؤسس این مجموعه به طور کامل آشنا می‌شیم</p>
