            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col-reverse xl:flex-row gap-8">
                    <div className="space-y-4 w-full xl:w-1/2 font-pelak-medium text-teal-500 leading-8">
                        ...
                        <p className="font-pelak leading-8 text-gray-800 dark:text-gray-200">در سه سال اخیر من تونستم با ده‌ها حافظ بین المللی از کشورهای مختلف صحبت کنم و از تجربیات اون‌ها در زمینه حفظ قرآن استفاده کنم. علاوه بر اون توفیق داشتم به صدها حافظ قرآن مشاوره بدم و در رفع مشکلات حفظی‌شون مؤثر باشم.</p>
                    </div>
