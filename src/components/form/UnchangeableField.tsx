    ...
    return (
        <div className={cn("flex flex-col gap-y-2", className)}>
            ...
            <div className="relative text-gray-500">
                <span className={cn("block p-4 w-full bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-200 border border-gray-100 dark:border-gray-800 rounded-xl transition-colors", filedClassName)}>{value}</span>
