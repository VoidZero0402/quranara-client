    ...
    return (
        <div className={cn("flex flex-col gap-y-2", className)}>
            ...
            <div className="relative text-gray-500">
                <input {...field} onChange={onChange} type={type} placeholder={placeholder} id={name as string} className={cn("py-2.5 px-3 w-full bg-white dark:bg-gray-800 dark:text-gray-200 border border-gray-100 dark:border-gray-800 focus:border-gray-200 dark:focus:border-gray-700 rounded-lg placeholder:text-gray-500 dark:placeholder:text-gray-400 transition-colors", inputClassName)} />
