    ...
    return (
        <div className={cn("flex flex-col gap-y-2", className)}>
            ...
            <div className="relative text-gray-500">
                <input {...field} onChange={onChange} type="number" placeholder={placeholder} id={name as string} className={cn("p-4 w-full bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-200 border border-gray-100 dark:border-gray-800 focus:border-gray-200 dark:focus:border-gray-700 rounded-xl placeholder:text-gray-500 dark:placeholder:text-gray-400  transition-colors", inputClassName)} />
