...
import QuestionStatus from "../../session/QuestionStatus";
...
function Question({ title, status, session, messages }: Question) {
    return (
        <div className="group space-y-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base leading-7 sm:leading-7 line-clamp-2">{messages[0].content}</p>
            </div>
            <Slice className="dark:opacity-50" />
            <div className="flex items-center justify-between font-pelak-medium">
                <span className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">{formatDate(new Date())}</span>
