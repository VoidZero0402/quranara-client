...
function Account() {
    return (
        // <Link href="/login">
        //     <Button rounded="lg" className="h-12 font-pelak-medium">
...
function UserAccount() {
    ...
    return (
        <div ref={ref} className="flex items-center relative">
            <Button onClick={toggleOpen} rounded="lg" variant="neutral-base" className="h-12 font-pelak-medium">
                حساب کاربری
            ...
            <Dropdown className={`absolute left-0 top-full w-72 dark:bg-gray-850 transition-all ${isOpen ? "visible opacity-100 mt-4" : "invisible opacity-0 mt-6"}`}>
                <DropdownHeader className="flex items-center gap-x-4 p-2">
                    ...
                    <div className="flex flex-col gap-y-2 transform-gpu">
                        <span className="font-pelak-medium text-md text-gray-800 dark:text-gray-200 line-clamp-1">رضا ملکی راد</span>
                        <div className="flex items-center gap-x-2">
                            <span className="text-sm text-gray-600 dark:text-gray-400">09121234501</span>
