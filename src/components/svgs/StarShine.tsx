...
function StarShine({ className = "w-6", strokeWidth = 1.5 }: SvgComponentProps) {
    return (
        <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M2 12L4 12" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M20 12L22 12" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M6 18L6.34305 17.657" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M17.6567 6.34326L18 6" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M18 18L17.657 17.657" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M6.34326 6.34326L6 6" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path
