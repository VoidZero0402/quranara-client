...
function Calendar({ className = "w-5", strokeWidth = 1.25 }: SvgComponentProps) {
    return (
        <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7 4V2.5" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M17 4V2.5" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M21.5 9H16.625H10.75M2 9H5.875" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
        </svg>
    );
}
