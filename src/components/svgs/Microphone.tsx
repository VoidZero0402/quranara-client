...
function Microphone({ className = "w-6", strokeWidth = 1.5 }: SvgComponentProps) {
    return (
        <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M11 8H13" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path d="M10 11L14 11" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
            <path
                ...
                fill="currentColor"
            />
            <path d="M12 19V22" stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" />
        </svg>
    );
}
